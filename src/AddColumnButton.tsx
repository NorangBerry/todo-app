	...
	render(){
		return (
			<>
			{
				...
				style={{width:"100%", backgroundColor:'#fff', boxShadow:"inset 0 0 0 2px #0079bf", border:"none",lineHeight:"20px", height:"90%"}}
				ref={node => this.title_input_ref = node}/>
				:
				<div className="text-block" style={{height:"20px", padding:"10px 8px",color:"#fff",
